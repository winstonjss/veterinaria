...
CREATE TABLE `tbl_diagnosticos` (
  ...
  `diag_descripcion` varchar(1000) NOT NULL,
  `tbl_citas_cit_id` int NOT NULL,
  PRIMARY KEY (`diag_id`,`tbl_citas_cit_id`),
  KEY `fk_tbl_diagnosticos_tbl_citas1_idx` (`tbl_citas_cit_id`),
  CONSTRAINT `fk_tbl_diagnosticos_tbl_citas1` FOREIGN KEY (`tbl_citas_cit_id`) REFERENCES `tbl_citas` (`cit_id`)
